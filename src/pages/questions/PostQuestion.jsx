    ...
    <>
      ...
      <div className="PostMainPage">
          { state?.displayForm === true 
            ? ( <button onClick={(event) => handleDisplayForm(event)}> COLLAPSE INSERT QUESTION </button> )
            : (<button onClick={(event) => handleDisplayForm(event)}> EXPAND INSERT QUESTION </button>)
          }
