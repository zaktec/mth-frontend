  ...
  return (
    <div className='PostMainPage'>
      { state?.displayForm === true
        ? (<button onClick={(event) => handleDisplayForm(event)}>COLLAPSE EDIT TUTOR</button>)
        : (<button onClick={(event) => handleDisplayForm(event)}>EXPAND EDIT TUTOR</button>)
      }

      {state.displayForm === true && (
        <div className='form-container'>
          <div className='form-header'>
            <div className='head'>EDIT TUTOR</div>
          </div>
