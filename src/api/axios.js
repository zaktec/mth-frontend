...
export const postAdminSignInApi = (resBody) => {
  console.log(resBody)
  return mthApi.post(`/adminsignin`, resBody
  )
  .then(({data}) => {
    return data.student; 
  });
...
export const postAdminLoginApi = (resBody) => {
  console.log(resBody)
  return mthApi.post(`/adminlogin`, resBody
  )
  .then(({data}) => {
    console.log(data)
    return data; 
...
export const getAdminHomepageApi = () => {
  return mthApi.get("/admin").then((res) => {
    console.log(res);
    return res.data.msg;
  });
};
