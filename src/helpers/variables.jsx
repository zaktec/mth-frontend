...
export const GET_SHAREABLE_LINK_API = `${SERVER_URL}/api/v1/auth/verify-shareable-link`;
...
export const POST_RESET_QUIZ_API = `${SERVER_URL}/api/v1/quizzes/post-reset-quiz`;
